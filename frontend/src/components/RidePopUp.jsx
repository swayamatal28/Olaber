        ...
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='flex mt-5 w-full items-center justify-between gap-4'>
                    <button onClick={() => {
                        props.setRidePopupPanel(false)
                    }} className='w-full bg-gray-300 text-gray-700 font-semibold p-3 rounded-lg'>Ignore</button>
                    <button onClick={() => {
                        props.confirmRide()
                    }} className='w-full bg-green-600 text-white font-semibold p-3 rounded-lg'>Accept</button>
                </div>
            </div>
        </div>
    )
